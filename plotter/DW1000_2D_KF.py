...
file_path = '/Users/chenlin/Desktop/plotter/DW1000_2D_KF.csv'
...
plt.title('ESP32 UWB DW1000 Indoor 2D Positioning System with Kalman Filter')
...
# # 将x轴移到顶部
# ax = plt.gca()
# ax.xaxis.set_ticks_position('top')   # 将x轴的刻度移到顶部
# ax.xaxis.set_label_position('top')   # 将x轴的标签移到顶部
