# Compare DW1000 and DW3000 in 1D system

import pandas as pd
import matplotlib.pyplot as plt


file_path1 = '/Users/chenlin/Desktop/plotter/DW1000_1D.csv'
df1 = pd.read_csv(file_path1)

file_path2 = '/Users/chenlin/Desktop/plotter/DW3000_1D.csv'
df2 = pd.read_csv(file_path2)


measured_distances1 = df1.iloc[:, 5].dropna()  # DW1000_1D.csv的第6列作为纵坐标
ideal_distances1 = df1.iloc[:, 7].dropna()  # DW1000_1D.csv的第8列作为横坐标

measured_distances2 = df2.iloc[:, 7].dropna()  # DW3000_1D.csv的第8列作为纵坐标
ideal_distances2 = df2.iloc[:, 10].dropna()  # DW3000_1D.csv的第11列作为横坐标
...
plt.title('Comparison of indoor ranging between DW1000 and DW3000 in 1D System')
