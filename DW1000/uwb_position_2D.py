...
distance_a1_a2 = 3.0
meter2pixel = 100  # 1 meter = 100 pixels
range_offset = 0.9
...
def main():
    ...
    csv_file_path = '/Users/chenlin/Desktop/plotter/test.csv'
    with open(csv_file_path, mode='w', newline='') as file:
        ...
        while True:
            ...
            if node_count == 2:
                ...
                print(x, y)
                writer.writerow([x, y])  # Save the coordinates to the CSV file
                clean(t_a3)
